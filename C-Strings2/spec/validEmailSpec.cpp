...
#pragma endregion 
		...
		void testDefault0_P1()
		{
			...
			Assert::AreEqual(0, actualAns, L"8Failed for Invalid case P1", 1, 2);
		};
		...
		void TC11_ValidEmail()
		{
			...
			Assert::AreEqual(0, actualAns, L"1Failed for Invalid case P1", 1, 2);
			testDefault1_P1();
		};
		...
		void TC19_ValidEmail()
		{
			...
			Assert::AreEqual(1, actualAns, L"9Failed for Invalid case P1", 1, 2);
			testDefault0_P1();
		};
